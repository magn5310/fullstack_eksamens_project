...
export default async function RestaurantPage({ params }: RestaurantPageProps) {
  ...
  const averageRating =
    restaurant.reviews.reduce((acc, review) => {
      const reviewAverage = (review.tasteScore + review.serviceScore + review.priceScore) / 3;
    ...
    <div className="max-w-3xl mx-auto border-none">
      <Card className="border-none shadow-none">
        <CardHeader>
          ...
          <Image
            className="align-center mx-auto rounded-2xl aspect-[4/3] object-cover"
            src={restaurant.imageUrl || "/images/kebab.jpg"} // Assuming images are named by slug
            alt={restaurant.name}
            width={800}
            height={250}
          ></Image>
